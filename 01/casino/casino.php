...
/**
 * Template Name: Casino Main Page
 *
 * Casino Main Page.
 *
 * @author Plutus
...
$agere_games_url =  $api_server_url . '/games/admin/getAllCombineAPI?action=available_games&token=' . agereToken() . '&casino=' . agereCasino(). '&gameType=all';
...
<div class="casino_main">
    ...
    <div class="casino_banner">
        <div class="casino_banner_text">
            <h1 class="h1-title">All Games</h1>
            <p>Play a wide variety of casino games!</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="casino_slider ">
                <?php
                $agere_slider_url =  $api_server_url . '/games/admin/getAllCombineAPI?action=feature-providers-games&token=' . agereToken() . '&casino=' . agereCasino().'&gameType=all';
                try {
                ...
                if (isset($all_slider_data) && !empty($all_slider_data)) {
                    all_casino_game_html($all_slider_data, 'casino', 'feature');
        ...
        <ul class="game-type-list">
            ...
            if (isset($all_gametypes)) {
                ...
                foreach ($all_gametypes as $key => $type) {
                    if (!(($type->name == 'Virtual') || ($type->name == 'OnlinePoker')) && !empty($type->name)) { ?>
...
?>
    <div class="load-more-div">
        <button class="game-load-more button" data-ajaxurl=" <?php echo admin_url('admin-ajax.php'); ?>" data-page="2" data-innerpage="casino" data-abort="1">Load More</button>
