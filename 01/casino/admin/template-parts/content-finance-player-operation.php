        ...
        <section class="user_main_sec">
            <div class="title_bar">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="title">
                            <h1 class="h1-title">Financial <?php  if('finance-agent-operation' === $page_slug){ echo 'Agents'; }else{ echo 'Players'; }  ?> </h1>
                        </div>
                    </div>
            ...
            <div class="user_main_sec_content">
                ...
                <div class="row">
                    <div class="col-lg-9">
                        ...
                        <table id="finance_player_operations" data-user-role="<?php  if('finance-agent-operation' === $page_slug){ echo 'agent'; }else{ echo 'player'; }  ?>" class="table table-striped table-bordered nowrap" style="width:100%">
                            <thead>
                                <tr>
                                    <th>User</th>
                                    <th>Balance</th>
