                ...
                <div class="main_content_box">
                    <section class="dashboard_main">
                        ...
                        <div class="row g-20 justify-content-center">
                            <div class="col-xl-4 col-lg-6">
                                <div class="dashboard_box">
                                    <h3 class="h3-title">Introduction</h3>
                                    <!--
									...
									-->
                                    <div class="button_group">
                                        <a href="javascript:void(0)" data-user-id="<?php echo get_current_user_id(); ?>" data-loader="1" data-target="add_referral_modal" class="sec-btn sm-btn modal-html-btn" title="Get Referral Link"> Get Referral Link <i class="far fa-plus-circle"></i>
                                        </a>
                                    </div>

                                    <div class="referral-link-response"></div>
                                    <?php
                            ...
                            <div class="col-xl-4 col-lg-12">
                                <div class="dashboard_box dashboard_chart_box">
                                    <h3 class="h3-title">Monthly Balance</h3>
                        ...
                        <div class="row g-20 ">
                            <div class="col-lg-8">
                                <div class="dashboard_box dashboard_chart_box">
                                    <h3 class="h3-title">Daily Balance</h3>
