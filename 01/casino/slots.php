...
// &gameSearch=slots
$agere_games_url =  $api_server_url . '/games/admin/getAllCombineAPI?action=available_games&token=' . agereToken() . '&casino=' . agereCasino().'&gameType=slots';

// echo '<pre>'; print_r($agere_games_url); echo '</pre>';
try {
...
<div class="casino_main">
    ...
    <div class="casino_banner">
        <div class="casino_banner_text">
            <h1 class="h1-title">Slot Games</h1>
            <p>Let's play over 1000 kinds of slot games!</p>
        </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="casino_slider ">
                <?php
                 $agere_slider_url =  $api_server_url . '/games/admin/getAllCombineAPI?action=feature-providers-games&token=' . agereToken() . '&casino=' . agereCasino().'&gameType=SlotPage';
                 try {
                 ...
                 if (isset($all_slider_data) && !empty($all_slider_data)) {
                     all_casino_game_html($all_slider_data, undefined, 'feature');
    ...
    <!-- <div class="group-item">
        <ul class="game-type-list">
            ...
            <?php
            // if (isset($all_gametypes) ) {

            //     foreach ($all_gametypes as $key => $type) {
            //         if (!(($type->name == 'LiveGames') || ($type->name == 'Virtual') || ($type->name == 'OnlinePoker')) && !empty($type->name)) { ?>
            //             <li data-gametype="<?php echo $type->name; ?>"><a href="javascript:void(0);"><?php echo $type->name; ?><span class="type-count"> <?php echo $type->gamesCount; ?></span></a>
            //             </li> <?php
            //                 }
            //             }
            //         }
    ...
    <div class="game-wrap">
        ...
        //  echo "</pre>";
        all_casino_game_html($all_available_game);
        ?>
    </div>
</div>
...
?>
    <div class="load-more-div">
        <button class="game-load-more button" data-ajaxurl=" <?php echo admin_url('admin-ajax.php'); ?>" data-page="2" data-innerpage="slots" data-abort="1" data-gametype="<?php echo $gametype; ?>">Load More</button>
...
<script src="<?php echo get_template_directory_uri() ?>/assets/js/casino-js.js?<?php echo time();?>"></script>
